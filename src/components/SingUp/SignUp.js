    ...
    return (
        <div className="w-full mx-auto my-5 max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-900 text-gray-100 ">
            ...
            <form onSubmit={handleSubmit(onSubmit)} action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input id="firstName" placeholder="leroy" className="w-full px-3 py-2 border rounded-md  border-gray-700  bg-gray-900  text-gray-100 focus: border-violet-400" {...register('firstName', { required: true })} />
                    ...
                    <div className="space-y-2">
                        ...
                        <input id="lastName" placeholder="lastName" className="w-full px-3 py-2 border rounded-md  border-gray-700  bg-gray-900  text-gray-100 focus: border-violet-400" {...register('lastName', { required: true })} />
                        {errors.lastName && <p className='text-red-500'>Last name is required.</p>}
                    </div>

                    <div className="space-y-2">
                        <label for="age" className="block text-sm">Enter Age</label>
                        <input id="age" placeholder="" className="w-full px-3 py-2 border rounded-md  border-gray-700  bg-gray-900  text-gray-100 focus: border-violet-400"  {...register('age', { pattern: /\d+/ })} />
                        {errors.age && <p className='text-red-500' >Please enter number for age.</p>}
                    </div>

                    <div className="space-y-2">
                        <label for="email" className="block text-sm">Email Address</label>
                        <input id="email" placeholder="leroy" className="w-full px-3 py-2 border rounded-md  border-gray-700  bg-gray-900  text-gray-100 focus: border-violet-400"  {...register('email', { required: true })} />
                    ...
                    <div className="form-control">
                        ...
                        <div className="text-md flex  justify-between mt-4  md:items-center xs:flex-col-reverse">
                            <div>
                                <button
                                    className="label-text font-semibold  text-[#8C9BB6] text-[#334155]"
                                ...
                                <div className="form-control ">
                                    <label className="label cursor-pointer  ">
                                        <div className="flex justify-around gap-2 items-center ">
                                            <p className="label-text font-semibold  text-[#8C9BB6] text-[#334155]">
                                                Show Password
                                            </p>
                                            <input
                                                onChange={() =>
            ...
            <div className="my-6 space-y-4">
                <button onClick={() => signInWithGoogle()} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1  border-gray-400 focus:ring-violet-400">
